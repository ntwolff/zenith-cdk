# todo (integrate)
# NeptuneNotebookRole-CDK += Trust relationship with rds service principal
# NeptuneNotebookRole-CDK += NeptuneFullAccess
...
class NeptuneStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        parameter_group_family = neptune.ParameterGroupFamily.NEPTUNE_1_3
        ...
        neptune_cluster = neptune.DatabaseCluster(self, "Neptune-CDK-Cluster",
            vpc=neptune_vpc,
            instance_type=neptune.InstanceType.R6_G_8_XLARGE,
        ...
        neptune_cluster.connections.allow_internally(ec2.Port.tcp(443))
